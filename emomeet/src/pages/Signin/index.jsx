                ...
                <div className="lg:flex lg:justify-between lg:items-center h-full">
                    ...
                    <div className="p-[2rem] max-w-[38rem]">
                        <div className="bg-grey px-[2rem] pb-[1.5rem] rounded-4xl overflow-hidden flex flex-col gap-3 lg:gap-5">
                            ...
                            <p className="text-center font-semibold text-xl uppercase lg:text-2xl">Signin</p>
                            <form action="" className="bg-darkblue text-white p-4 lg:p-6 py-[1.5rem] lg:py-[2rem] flex flex-col gap-6 rounded-3xl lg:gap-9">
                                <div className="border-1 rounded-full flex items-center px-[0.5rem] lg:px-[1rem]">
                                    ...
                                    <input type="email" name="email" id="email" className="w-full placeholder:text-gray-400 p-2 focus:border-0 focus:outline-0 lg:text-2xl" placeholder="Email" />
                                </div>
                                <div className="border-1 rounded-full flex items-center px-[0.5rem] lg:px-[1rem]" >
                                    <FaLock className="size-4 lg:size-6" />
                                    <input type="password" name="password" id="password" className="w-full placeholder:text-gray-400 p-2 focus:border-0 focus:outline-0 lg:text-2xl"  placeholder="Password"/>
                                </div>
                                <div>
                                    <button className="bg-lightblue w-full px-[2rem] py-[0.5rem] rounded-full font-semibold text-lg uppercase lg:text-2xl">Sign in</button>
                                </div>
                            </form>
                            <p className="uppercase text-sm text-center font-semibold lg:text-xl">New to Emo ? <Link to={'/signup'} className="text-lightblue">sign up</Link> </p>
                            </div>
                    </div>
                    </div>
                    <div className="lg:w-1/2 flex justify-center">
